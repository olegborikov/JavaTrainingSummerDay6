...
import com.borikov.day6.controller.command.impl.SortBooksByPublishingHouseCommand;
...
public class SortBooksByPublishingHouseCommandTest {
    private SortBooksByPublishingHouseCommand sortBooksByPublishingHouseCommand;
    private BookStorageCreator bookStorageCreator;

    @BeforeClass
    public void setUpClass() throws StorageException {
        sortBooksByPublishingHouseCommand = new SortBooksByPublishingHouseCommand();
    ...
    public void tearDownClass() {
        sortBooksByPublishingHouseCommand = null;
    ...
    public void executePositiveTest() {
        ...
        Map<String, List<Book>> actual =
                sortBooksByPublishingHouseCommand.execute(data);
