...
public class SortBooksByPublishingYearCommandTest {
    private SortBooksByPublishingYearCommand sortBooksByPublishingYearCommand;
    private BookStorageCreator bookStorageCreator;

    @BeforeClass
    public void setUpClass() throws StorageException {
        sortBooksByPublishingYearCommand =
                new SortBooksByPublishingYearCommand();
    ...
    public void tearDownClass() {
        sortBooksByPublishingYearCommand = null;
    ...
    public void executePositiveTest() {
        ...
        Map<String, List<Book>> actual =
                sortBooksByPublishingYearCommand.execute(data);
